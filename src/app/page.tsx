        ...
        <div className="flex flex-col items-center gap-4 w-full">
          ...
          <div className="grid grid-cols-3 gap-4 justify-center">
            {character.slice(0, 3).map((char) => (
              <motion.div
                key={char.id}
                className={`w-24 h-24 rounded-lg flex items-center justify-center cursor-pointer text-lg font-bold shadow-lg transition-all border-2 ${selected === char.id ? "scale-110 border-stone-500" : "border-transparent"
                  }`}
